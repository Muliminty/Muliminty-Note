...
But I’ve also come to see it not as a flaw of Hooks but as a mismatch between the [React programming model](../react-as-a-ui-runtime/index.md) and `setInterval`. Hooks, being closer to the React programming model than classes, make that mismatch more prominent.
