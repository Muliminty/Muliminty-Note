...
![Yoda sniffing the air. Caption: “I smell bacon.”](./img/yoda.jpg)
...
![Screen recording of 1, 2, 3, 4, 5 logged in order](./img/timeout_counter.gif)
...
![Screen recording of 5, 5, 5, 5, 5 logged in order](./img/timeout_counter_class.gif)
...
![Screen recording of 5, 5, 5, 5, 5 logged in order](./img/timeout_counter_refs.gif)
...
![Deja vu (cat scene from the Matrix movie)](./img/deja_vu.gif)
...
![Diagram of effects replacing one another](./img/deps-compare-correct.gif)
...
![Diagram of effects replacing one another](./img/deps-compare-wrong.gif)
...
![Diagram of stale interval closure](./img/interval-wrong.gif)
...
![Diagram of interval that re-subscribes](./img/interval-rightish.gif)
...
![Diagram of interval that works](./img/interval-right.gif)
...
![Lint rule gif](./img/exhaustive-deps.gif)
