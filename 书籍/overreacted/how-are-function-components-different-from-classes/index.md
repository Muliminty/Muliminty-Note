...
![Spot the difference between two versions](./img/wtf.gif)
...
![Demonstration of the steps](./img/bug.gif)
...
![Capturing Pokemon](./img/pokemon.gif)
...
![Demo of correct behavior](./img/fix.gif)
...
![Smiling Pikachu](./img/pikachu.gif)
