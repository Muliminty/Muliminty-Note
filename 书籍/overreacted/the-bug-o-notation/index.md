...
Many online discussions about APIs are primarily concerned with aesthetics. But that [doesn’t say much](../optimized-for-change/index.md) about what it feels like to use an API in practice.
