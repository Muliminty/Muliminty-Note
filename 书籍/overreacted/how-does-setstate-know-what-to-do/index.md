...
**Disclaimer: Just like [most](../why-do-react-elements-have-typeof-property/index.md) [other](../how-does-react-tell-a-class-from-a-function/index.md) [posts](../why-do-we-write-super-props/index.md) on this blog, you don’t actually *need* to know any of that to be productive with React. This post is for those who like to see what’s behind the curtain. Completely optional!**
