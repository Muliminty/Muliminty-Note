...
当你学完 [LLM 原理](./01-LLM 原理.md) 和 [Transformer 架构](./02-Transformer 架构.md) 之后，会发现"让 AI 真正可用"远不止理解模型本身——你还需要知道怎么跟它沟通、怎么控制它、怎么让它稳定地服务于生产环境。
...
更多技巧详见 [04-Prompt Engineering](./04-Prompt Engineering.md)。
...
- [01-LLM 原理](./01-LLM 原理.md)：理解 LLM 的基本工作机制
- [04-Prompt Engineering](./04-Prompt Engineering.md)：沟通线第一代工程的详细实践
- [05-RAG 原理](./05-RAG 原理.md)：基础设施层核心学科
- [06-Agent 原理](./06-Agent 原理.md)：自主执行任务的架构设计
