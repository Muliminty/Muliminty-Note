...
本目录用于收录 AI 应用落地相关内容，当前主要覆盖三条主线：

- MCP（Model Context Protocol）相关应用开发
- A2A（Agent2Agent Protocol）相关协议与应用开发
...
| 06 | [A2A 协议](./06-A2A协议.md) | A2A 的定位、核心概念、三种通信模式与 MCP 互补关系 |
...
5. 接着看 [A2A 协议](./06-A2A协议.md)，理解 Agent 间如何通信协作，以及 A2A 与 MCP 的互补关系。
6. 如果你要系统学习 RAG，进入 [RAG 专题](./RAG/README.md)，先看 [RAG 原理](../01-AI基础理论/05-RAG%20原理.md)，再按专题顺序阅读后续 10 篇正式文章。
