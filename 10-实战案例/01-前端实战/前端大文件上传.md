...
> 
> **参考文档**：
> - [File API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/09-File-API.md) — 文件对象操作
> - [Blob API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/10-Blob-API.md) — 二进制大对象
> - [FileReader API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/11-FileReader-API.md) — 文件读取
> - [FormData API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/12-FormData-API.md) — 表单数据和文件上传
...
- [FileReader API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/11-FileReader-API.md) — 文件读取
- [FormData API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/12-FormData-API.md) — 表单数据和文件上传
- [Fetch API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/05-Fetch-API.md) — 网络请求

### 进阶学习
- [Web Workers](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/17-Web-Workers.md) — 多线程处理
- [Storage API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/08-Storage-API.md) — 客户端存储
- [Service Worker](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/18-Service-Worker.md) — 离线支持
