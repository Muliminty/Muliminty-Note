...
status: "成熟"
tags: ["前端实战", "SSO", "认证", "单点登录"]
description: "梳理单点登录方案的核心概念、价值与常见实现思路。"
toc: true
publish: true
---
...
#### 3. **Cookie 共享**
同一域名下的 Cookie 可以共享，这是实现 SSO 的基础。详见 [Cookie-API - Domain（域名）](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#domain域名)。
...
- 详细说明请参考 [Cookie-API - 为什么两个站点的 Cookie 不共享？](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#为什么两个站点的-cookie-不共享)
...
- Cookie → [Cookie-API](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md) — Cookie 完整知识体系（Domain、Path、Secure、SameSite）
  - [Cookie-API - Domain（域名）](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#domain域名) — 跨子域 Cookie 共享的核心
  - [Cookie-API - 为什么两个站点的 Cookie 不共享？](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#为什么两个站点的-cookie-不共享) — 理解 Cookie 共享原理
  - [Cookie-API - 如何在控制台正确设置跨子域 Cookie？](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#如何在控制台正确设置跨子域-cookie) — 实践指南
  - [Cookie-API - 场景2：单点登录（SSO）与跨子域 Cookie 共享](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#场景2单点登录sso与跨子域-cookie-共享) — SSO 实际应用
...
> 💡 **相关知识点**：详细原理请参考 [Cookie-API - 如何在控制台正确设置跨子域 Cookie？](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#如何在控制台正确设置跨子域-cookie)
...
**为什么错**：Cookie 的 `domain` 属性设置不正确，导致子域名无法读取。详见 [Cookie-API - 错误1：Domain 设置错误，导致子域名无法共享](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#错误1domain-设置错误导致子域名无法共享)。
...
**更多示例**：参考 [Cookie-API - 常见错误示例](../../02-编程语言/01-JavaScript/08-浏览器环境与DOM/13-Cookie-API.md#常见错误示例) 了解完整的错误场景和解决方案。
...
本文档遵循 [语法规范](../../99-系统/01-百科写作规范.md) 的格式要求，使用标准的 Markdown 语法和链接格式。
