...
tags: ["Nginx", "配置管理", "基础入门", "Web服务器"]
moc: "[[!MOC-Nginx]]"
stage: "基础入门"
prerequisites: ["Nginx 安装与环境配置", "Nginx 核心概念"]
description: "说明 Nginx 的配置文件位置、语法规则、上下文结构、include 机制与配置组织方式。"
publish: true
aliases: ["配置文件结构", "Nginx 配置结构"]
toc: true
---
