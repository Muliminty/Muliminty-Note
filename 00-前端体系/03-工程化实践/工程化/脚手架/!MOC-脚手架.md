...
> 
> **学习路径**：学习脚手架前需要掌握 [Node.js 基础](../../../../03-服务端/01-服务端语言/Node.js/!MOC-Node.js.md) 和 [TypeScript](../../../02-框架进阶/TypeScript/!MOC-TypeScript.md)。脚手架与 [构建工具](../../工具链与构建/!MOC-工具链与构建.md) 和 [工程化实践](../!MOC-工程化.md) 密切相关。
