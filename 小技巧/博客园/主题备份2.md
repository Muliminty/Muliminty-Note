---
link: null
title: 博客园主题美化 - 阳仔真的很忙 - 博客园
description: 更新：找到Github原地址了Cnblogs-Theme-SimpleMemory-BNDong 在此记录一下本博客的第一个主题美化的过程，方便后续自己查看，也方便有需要的小伙伴自取。 本人小白，主题
keywords: null
author: 我的博客 我的园子 账号设置 简洁模式 ... 退出登录
date: 2022-01-12T13:10:00.000Z
publisher: null
stats: paragraph=656 sentences=1910, words=13940
---
更新：找到Github原地址了[Cnblogs-Theme-SimpleMemory-BNDong](https://github.com/BNDong/Cnblogs-Theme-SimpleMemory)

在此记录一下本博客的第一个主题美化的过程，方便后续自己查看，也方便有需要的小伙伴自取。

**本人小白，主题美化过程及相关源码参照网络资料，由于时间太长忘记了原帖们都是什么了只依稀记得有如下，如有侵权请联系我。**

【参考】：

* [博客园美化教程 - Huny - 博客园 (cnblogs.com)](https://www.cnblogs.com/huny/p/13388994.html)
...
JS权限审核通过后，在设置>博客皮肤选择 `SimpleMemory`。（必须选择这个皮肤，因为后面代码是基于这个皮肤）
...
.day, .div_my_zzk, .postMeta, .postSticky {
    position: relative
}
...
#author_profile, #div_digg, #topics .postDesc {
    margin-top: 5px
}
...
#div_digg, .commentbox_title_right, .pfl_feedbackManage {
    float: right
}
...
#introduce a:active, #introduce a:hover, #introduce a:link, #introduce a:visited, .scroll-down {
...
设置完页面定制代码之后需要勾选【禁用模板默认CSS】。

#### 2、博客侧边栏公告

侧边栏公告代码参考如下，其中文字内容和图片地址换成自己需要的即可。

```html

    window.cnblogsConfig = {
      title: { // 网页title
        onblur: '博客', // 网页失去焦点时，页面显示的文字
        onblurTime: 500, // 当页面失去焦点，页面title变化的延时时间，单位毫秒
        focus: '欢迎回来！', // 当页面获取焦点，页面title显示的文字；显示后，延时恢复原title。
      },
      info: { // 基础信息
        name: 'YourName', // 用户名
        startDate: '2022-01-12', // 入园时间，年-月-日。入园时间查看方法：鼠标停留园龄时间上，会显示入园时间
        avatar: 'https://XXXXXX/forest.jpg', // 用户头像
        blogIcon: 'https://XXXXXX/forest.jpg', // 网站图标
      },
      banner: { // 横幅
        home: {
          titleSource: 'jinrishici',
          background: [
            "https://XXXXXX/forest.jpg",
          ],
        },
        article: {
            background: [ //图片地址
                "https://XXXXXX/forest.jpgg",
                "https://XXXXXX/nature-7680x4320-8k-21456.jpg",
                "https://XXXXXX/forest-deer-4k-5k-11925.jpg",
                "https://XXXXXX/clouds-4k-23187.jpg",
                "https://XXXXXX/artwork-4k-20035.jpg",
            ],
        },
      },
      footer: { // 页脚
      ...
      rtMenu: { // 二维码
        qrCode: 'https://XXXXXX/avatar_01.jpg',
      },
      animate: { // 动效
        homeBanner: { // 主页动效
          enable: false,
      ...
      code: { //代码
        ...
        options: { //渲染设置
          ...
          line: true, // 行号
          macStyle: false, //mac风格代码框样式
        }
      },
      /*articleSuffix: { //文章后缀
        aboutHtml: "I am a good person", //关于博主
        copyrightHtml: "版权...", //版权声明
        supportHtml: "声援...", //声援博主
      },*/
    }
...
代码如下，在原代码基础上进行了有一些效果更改，调整了彩带和鼠标吸附线条的效果。不需要调整动画效果的话直接复制代码即可。
...
POWERMODE.colorful = true;POWERMODE.shake = true;POWERMODE.mobile = false;document.body.addEventListener('input', POWERMODE);
```

#### 4、效果如下

![](https://gitee.com/ouyangzhikui/images_for_md/raw/master/images/202201122101677.png)

![](https://gitee.com/ouyangzhikui/images_for_md/raw/master/images/202201122102637.png)
