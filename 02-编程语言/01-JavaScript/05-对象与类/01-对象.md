...
tags: ["javascript", "对象", "面向对象", "前端基础"]
moc: "[[!MOC-JavaScript]]"
description: "对象是 JavaScript 中最重要的数据类型，用来组织和存储数据。"
publish: true
toc: true
---
...
- [类](./02-类.md) - 基于对象的类语法
- [原型与继承](./03-原型与继承.md) - 对象的继承机制
- [this 绑定](./04-this绑定.md) - 对象方法中的 this
- [数据类型](../01-语言核心/03-数据类型.md) - 对象是引用类型
