...
今天在该模块的第一篇文章，我们主要讲解[执行上下文](../../../00-编程/前端基础-JavaScript/编译原理/执行上下文.md)相关的内容。那为什么先讲执行上下文呢？它这么重要吗？可以这么说，只有理解了JavaScrip的执行上下文，你才能更好地理解JavaScript语言本身，比如变量提升、作用域和闭包等。不仅如此，理解执行上下文和调用栈的概念还能助你成为一名更合格的前端开发者。
...
要解释这两个问题，你就需要先了解下什么是[变量提升](../../../00-编程/前端基础-JavaScript/编译原理/执行上下文.md)。
