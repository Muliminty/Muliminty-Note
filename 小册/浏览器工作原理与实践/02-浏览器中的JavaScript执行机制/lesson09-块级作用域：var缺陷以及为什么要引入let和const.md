...
为什么`JavaScript`中会存在变量提升这个特性，而其他语言似乎都没有这个特性呢？要讲清楚这个问题，我们就得先从[作用域](../../../00-前端/00-Core/JavaScript/前端基础-JavaScript/02-进阶机制/深入-知识点/深入：作用域（Scope）.md)讲起
...
![](./附件/55b8177d-85bf-4577-a4e2-fd2b74c0bae4_1739515460313.png)
