...
**为什么错**：props 是只读的，就像函数的参数一样，不能修改。要修改数据，需要使用 [State（状态）](../03-状态管理/01-State（状态）.md)。
...
- [JSX 语法](../01-语法基础/01-JSX-语法.md) - 组件用 JSX 写
- [Props（属性）](./01-Props（属性）.md) - 组件之间传递数据
- [State（状态）](../03-状态管理/01-State（状态）.md) - 组件内部的数据
- [事件处理](../04-事件处理/01-事件处理.md) - 组件中的用户交互
- [组件组合](./03-组件组合.md) - 如何组合组件
