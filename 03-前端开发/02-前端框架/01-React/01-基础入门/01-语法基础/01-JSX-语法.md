...
**重要**：必须给每个列表项添加 `key` 属性，帮助 React 识别哪些项改变了。详见 [列表渲染 Key 的使用](./04-列表渲染-Key的使用.md)。
...
- [组件（Components）](../02-组件基础/02-组件（Components）.md) - JSX 用来写组件
- [Props（属性）](../02-组件基础/01-Props（属性）.md) - 在 JSX 中传递属性
- [State（状态）](../03-状态管理/01-State（状态）.md) - 在 JSX 中使用状态
- [条件渲染](./02-条件渲染.md) - JSX 条件渲染详解
- [列表渲染](./03-列表渲染.md) - JSX 列表渲染详解
